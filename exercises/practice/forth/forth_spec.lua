...
describe('forth', function()
  ...
  describe('addition', function()
    ...
    it('more than two values on the stack', function()
      assert.are.same({ 1, 5 }, forth.evaluate({ '1 2 3 +' }))
    end)
  end)
  ...
  describe('subtraction', function()
    ...
    it('more than two values on the stack', function()
      assert.are.same({ 1, 9 }, forth.evaluate({ '1 12 3 -' }))
    end)
  end)
  ...
  describe('multiplication', function()
    ...
    it('more than two values on the stack', function()
      assert.are.same({ 1, 6 }, forth.evaluate({ '1 2 3 *' }))
    end)
  end)
  ...
  describe('division', function()
    ...
    it('more than two values on the stack', function()
      assert.are.same({ 1, 4 }, forth.evaluate({ '1 12 3 /' }))
    end)
  end)
  ...
  describe('combined arithmetic', function()
    ...
    it('multiplication and addition', function()
      assert.are.same({ 13 }, forth.evaluate({ '1 3 4 * +' }))
    end)

    it('addition and multiplication', function()
      assert.are.same({ 7 }, forth.evaluate({ '1 3 4 + *' }))
    end)
  end)
