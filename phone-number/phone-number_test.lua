...
describe('PhoneNumber()', function()
  ...
  it('cleans the number (123) 456-7890', function()
    ...
    assert.are.equal('1234567890', phone.number)
  end)
  ...
  it('invalid when 11 digits', function()
    ...
    assert.are.equal('0000000000', phone.number)
  end)
  ...
  it('has an area code', function()
    ...
    assert.are.equal('123', phone:areaCode())
  end)

  it('formats a number', function()
    local phone = PhoneNumber:new('1234567890')
    assert.are.equal('(123) 456-7890', phone:toString())
  end)
